import {Button, Checkbox, Chip, Divider, Sheet, Textarea, TextField, Typography} from "@mui/joy";
...
export default function EditCours({content}: { content: CoursModel }) {
    ...
    return (<>
        ...
        <div className="h-full w-full flex flex-col grid grid-cols-12">
            <div className="col-span-12 md:col-span-4 xl:col-span-4 shadow overflow-x-hidden">
                <DetailCours cours={contentState} setCours={setContentState}/>
            </div>
            <div className="col-span-12 md:col-span-8 xl:col-span-8 px-6 mt-8">
                <ContentCours cours={contentState} setCours={setContentState}/>
            </div>
        </div>
    </>);
}
