    ...
    return (<div>
        <div className="text-gray-50 bg-blue-600 shadow flex gap-0.5 h-14 w-full z-10">
            <div className="min-w-min px-4 h-full flex items-center justify-center">
                <button
                    className="hidden md:flex items-center justify-center px-2 py-1 rounded-md border-2 text-sm text-gray-200 hover:text-blue-900 hover:border-blue-900">
                    <StoriesIcon/>
                    <span className="pl-1">{user && user?.name}</span>
                </button>
                <button className="block md:hidden px-2 py-1 rounded-md border-2">
